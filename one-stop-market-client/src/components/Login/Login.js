    ...
    return (
        <div className = "text-center">
            ...
            <form style ={formStyle}onSubmit={handleSubmit}>
                ...
                <p>or</p>
                <button className = "btn btn-danger w-100 mb-1 rounded-pill" onClick = {handleGoogleSignIn}><img style = {{height: '30px', marginRight : '10px'}} src = {google} />Continue with Google</button>
            </form>
